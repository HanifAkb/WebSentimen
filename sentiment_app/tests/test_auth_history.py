...
class AuthAndHistoryTests(TestCase):
    ...
    def test_custom_admin_shows_users_and_history_datasets(self):
        ...
        self.assertContains(response, "Dataset Hasil Prediksi")
        self.assertContains(response, "Dataset Hasil Scraping")
        ...
        self.assertContains(response, '<th class="text-center">Jumlah Data</th>', html=True)
        self.assertContains(response, '<th class="text-center">Jumlah Tweet</th>', html=True)
    ...
    def test_history_list_only_shows_owner_data(self):
        ...
        self.assertNotContains(response, "<th>Tipe</th>", html=True)
        self.assertContains(response, '<span class="badge text-bg-info">Kalimat</span>', html=True)
