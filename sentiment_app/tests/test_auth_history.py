...
class AuthAndHistoryTests(TestCase):
    ...
    def test_scrape_history_dashboard_content_returns_dashboard_html(self):
        ...
        self.assertIn("Distribusi Sentimen Gabungan", payload["html"])
        self.assertIn("Soft Voting", payload["html"])
        self.assertIn("combinedSmallPieChart", payload["html"])
        self.assertIn("combinedPieChart", payload["html"])
        self.assertIn("data-dashboard-main-pie-title", payload["html"])
        self.assertIn("Distribusi Sentimen (SVM)", payload["html"])
