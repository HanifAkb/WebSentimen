...
SENTIMENT_MODELS_DIR = BASE_DIR / "sentiment_site" / "models"
...
SENTIMENT_TWITTER_MAX_TWEETS_PER_REQUEST = _env_int("SENTIMENT_TWITTER_MAX_TWEETS_PER_REQUEST", 1500)
...
SENTIMENT_TWITTER_MAX_RUNTIME_SECONDS = _env_int("SENTIMENT_TWITTER_MAX_RUNTIME_SECONDS", 22)
